...
- ライバルやパチパチ団
    - 現状は前後NodeのEdgeを10.5や20.5に集中させる作りになっているけど、そうじゃなくて、row10からrow11へのEdgeは以前のとおりで、それら全ての通過点でライバルやパチパチ団のイベントが発生するって感じにしたい！つまり、ライバルやパチパチ団のNodeから、row11の全てのNodeを選択できるのはダメ！row10からrow11を既存Edgeで選択する！
    Map上での表示として、row10とrow11の間をもっと広く取って、そこに水平線を点線で引く！水平線の右端にライバルやパチパチ団（現状通り）、水平線の左端に博士！
    row11に向かう際に、その水平線を通ってライバルがやってくる演出も！
...
- びしょ濡れ
電攻撃を受けた場合は漏電と同等の効果。
炎攻撃を受ける場合は蒸発してValueに応じた貫通を適応。
草攻撃なら花粉症を付与。
毒の場合はダメージじゃなく毒素が付与されたときに、付与値を増加。
氷の場合も冷気付与時に、冷気の代わりに凍結を付与（びしょ濡れValueに応じて冷気Valueを凍結Valueに変換）
風ダメージの場合は風化。
竜の場合はドラゴンクランカーだっけ？を付与。
